...
#java
export JAVA_HOME=$__/bins/Java/jdk1.8.0_144
export CLASSPATH=.:$JAVA_HOME/lib/tools.jar:$JAVA_HOME/lib/dt.jar
export IDEA_PROPERTIES=$HOME/.IntelliJIdea/idea.properties

#path
export PATH=$JAVA_HOME/bin:$PYTHONHOME:$PYTHONHOME/$PYTHON_SCRIPTS:$NODE_HOME/$_NODEJS_:$npm_config_prefix:$NVM_HOME:$HOME/.bin:$PATH
